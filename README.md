...
- China and global ecosystems, with evidence levels for every entry
...
| Name | Organization | Region | Role | Evidence | Links |
| --- | --- | --- | --- | --- | --- |
...
| Alibaba Cloud Model Studio MCP | Alibaba Cloud | China | MCP services, custom MCP, marketplace | A | [Docs](https://help.aliyun.com/zh/model-studio/mcp-introduction) |
| ModelScope MCP Marketplace | ModelScope | China | MCP marketplace and benchmark ecosystem | A | [Marketplace](https://modelscope.cn/mcp) |
| Baidu Qianfan / Comate MCP | Baidu | China | AppBuilder/Comate MCP support and tools | A | [Docs](https://cloud.baidu.com/doc/AI_REFERENCE/s/Dm9qfl477) |
| Tencent Yuanqi / CloudBase MCP | Tencent | China | MCP plugins, CloudBase MCP, ADP MCP | A | [Yuanqi](https://yuanqi.tencent.com/guide/plugin-market-integrate-mcp-plugin) |
| Huawei AgentArts MCP | Huawei Cloud | China | MCP marketplace, custom MCP services | A | [Docs](https://support.huaweicloud.com/usermanual-agentarts/agentarts_05_0137.html) |
| MiniMax MCP | MiniMax | China | Official MCP server and docs | A | [Docs](https://platform.minimax.io/docs/guides/mcp-guide) |
| Z.ai MCP Calling | Z.ai | China | API-level MCP server calling | A | [Docs](https://docs.z.ai/guides/capabilities/mcp-call) |
| Kimi Playground MCP | Moonshot AI | China | MCP client integration via ModelScope and CLI | B | [Docs](https://platform.kimi.ai/docs/guide/configure-the-modelscope-mcp-server) |

## Official Agent Skills

| Name | Organization | Region | Skill Format | Evidence | Links |
| --- | --- | --- | --- | --- | --- |
...
| MiniMax Skills | MiniMax | China | Agent Skills repository | A | [Repo](https://github.com/MiniMax-AI/skills) |
| Huawei AgentArts Skill | Huawei Cloud | China | Platform Skill | A | [Docs](https://support.huaweicloud.com/lowcode-agentarts/agentarts_05_01301.html) |
