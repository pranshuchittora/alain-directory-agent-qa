...
| Alibaba Cloud Model Studio MCP | Alibaba Cloud | `mainland-china` | MCP services, custom MCP, marketplace | A | [Docs](https://help.aliyun.com/zh/model-studio/mcp-introduction) |
| ModelScope MCP Marketplace | ModelScope | `mainland-china` | MCP marketplace and benchmark ecosystem | A | [Marketplace](https://modelscope.cn/mcp) |
| Baidu Qianfan / Comate MCP | Baidu | `mainland-china` | AppBuilder/Comate MCP support and tools | A | [Docs](https://cloud.baidu.com/doc/AI_REFERENCE/s/Dm9qfl477) |
| Tencent Yuanqi / CloudBase MCP | Tencent | `mainland-china` | MCP plugins, CloudBase MCP, ADP MCP | A | [Yuanqi](https://yuanqi.tencent.com/guide/plugin-market-integrate-mcp-plugin) |
| Huawei AgentArts MCP | Huawei Cloud | `mainland-china` | MCP marketplace, custom MCP services | A | [Docs](https://support.huaweicloud.com/usermanual-agentarts/agentarts_05_0137.html) |
| MiniMax MCP | MiniMax | `mainland-china / international` | Official MCP server and docs | A | [Docs](https://platform.minimax.io/docs/guides/mcp-guide) |
| Z.ai MCP Calling | Z.ai | `mainland-china / international` | API-level MCP server calling | A | [Docs](https://docs.z.ai/guides/capabilities/mcp-call) |
| Kimi Playground MCP | Moonshot AI | `mainland-china` | MCP client integration via ModelScope and CLI | B | [Docs](https://platform.kimi.ai/docs/guide/configure-the-modelscope-mcp-server) |
